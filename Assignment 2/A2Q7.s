...
///////////////////////////////////////
.data
my_data: .word 0x0//declare mydata with value ==0

.text
LDR R3, =my_data//load address mydata into r3
MOVE R2, #0x890002//create mask to toggle bits 8, 19, 25
EOR R3, R3, R2 //toggle bit 8,19,25 of mydata
